...
export default class DinoGame extends GameRunner {
  ...
  getFunFact() {
    const funFacts = [
      'Steam whistles were also used in traction engines!',
      'A group of steam whistles playing music is called a calliope!',
      'Organ whistles are a type of steam whistle',
      'Steam whistles were first used as alarms for boilers!',
      'Steam whistle serves the purpose of generating acoustic signals',
      'Bill and Wally came from Exide Technologies!',
      'The whistle consists of these parts: the Steam orifice and the valve!',
      'Wally was the last whistle to ever be heard in Trenton!',
      'Bill Miller was employed by Stokes Molded products ESB from 1950 to 1988',
      'Wally is currently located in the Trentoniana Exhibit!',
    ]
